...
await amm.volume(mint, minSolPerSwap, maxSolPerSwap, mCapFactor, speedFactor, {jitoTipLamports: 30001}) // higher mCap factor = chart goes up. 0 = no increase or decrease - net neutral.
